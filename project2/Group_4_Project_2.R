...
# we can balance the dataset to an 80:20 ratio using the ROSE package

important_data_balanced = ovun.sample(TARGET~., data = important_data, method = "both",  p=0.2)$data
